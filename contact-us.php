    ...
    <div class="contact-banner-left-panel">
        ...
        <div class="banner-content">
            ...
            <table>
                <tr>
                    <td>Gourav:</td>
                    <td><span class="banner-table-contact-text">+94 76 450 xxxx</span></td>
                </tr>
                <tr>
                    <td>Jatin:</td>
                    <td><span class="banner-table-contact-text">+94 71 999 xxxx</span></td>
                </tr>
                <tr>
                    <td>Harshit:</td>
                    <td><span class="banner-table-contact-text">+94 70 530 xxxx</span></td>
                </tr>
            </table>
        </div>
        <div class="banner-content">
            ...
            <table>
                <tr>
                    <td>Gourav:</td>
                    <td><span class="banner-table-contact-text">gourav@gmail.com</span></td>
                </tr>
                <tr>
                    <td>Jatin:</td>
                    <td><span class="banner-table-contact-text">Jatin@gmail.com</span></td>
                </tr>
                <tr>
                    <td>Harshit:</td>
                    <td><span class="banner-table-contact-text">harshit@gmail.com</span></td>
                </tr>
            </table>
        </div>
    </div>
    ...
    <div class="footer-row">
        ...
        <div class="footer-column">
            ...
            <table>
                <tr>
                    <td>Gourav:</td>
                    <td>+94 76 450 xxxx</td>
                </tr>
                <tr>
                    <td>Jatin:</td>
                    <td>+94 71 999 xxxx</td>
                </tr>
                <tr>
                    <td>Harshit:</td>
                    <td>+94 70 530 xxxx</td>
                </tr>
            </table>
        </div>
        <div class="footer-column">
