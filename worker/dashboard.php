    ...
    <section class="main-content">
        ...
        <div class="recent-payments">
            ...
            <div class="recent-payments-container">
                <?php
                    require_once "../db.php";
                    $sql = "SELECT Payment_Log.*, Booking.Booking_ID, Customer.First_Name AS CustomerFirstname, Customer.Last_Name AS CustomerLastname, Worker.First_Name AS WorkerFirstname, Worker.Last_Name AS WorkerLastname FROM Payment_Log INNER JOIN Booking ON Payment_Log.Booking_ID = Booking.Booking_ID INNER JOIN User AS Worker ON Booking.Worker_ID = Worker.User_ID INNER JOIN User AS Customer ON Booking.Customer_ID = Customer.User_ID WHERE Booking.Worker_ID = {$_SESSION['user_id']} ORDER BY Timestamp DESC LIMIT 4";
                    $result = $conn->query($sql);
