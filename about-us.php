...
<div class="developer-container">
    ...
    <div class="developers">
        <div class="developer">
            <img src="./assets/about-us/gourav.jpg">
            <h2>Gourav</h2>
            <h2>(Leader)</h2>
        </div>
        <div class="developer">
            <img src="./assets/about-us/jatin.jpg">
            <h2>Jatin</h2>
        </div>
        <div class="developer">
            <img src="./assets/about-us/harshit.jpg">
            <h2>Harshit</h2>
        </div>
        <div class="developer">
            <img src="./assets/about-us/dhruv1.jpg">
            <h2>Dhruv</h2>
        </div>
    </div>
</div>
<div class="details-container">
    <div class="left-column">
        <h3>About us</h3>
        <p>We are a group of Second Year Computer Science undergraduates from  Maharishi Markandeshwar University,Mullana of
            to become professionals in the field of Software Development.
